                ...
                <div className='signup__container-block block login__form'>
                    <div className='signup__container-form'>
                        ...
                        <div className='signup__container-formBody'>
                            ...
                            >
                                <Tooltip disableFocusListener title="enter your username" placement="right-start">
                                ...
                                <Tooltip disableFocusListener title="enter your password" placement="right-start">
                        ...
                        <div className='signup__container-footer'>
                            <p><Link className="link" to='/sign-up'>sign up</Link> to create an account</p>
                        </div>
                    </div>
                </div>
            </div>
            {error && <SnackbarComponent handle={true} message={errorMessage} type={"error"} />}
        </>
    )
}
